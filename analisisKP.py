...
if testEstadistico:
    for instancia in instancias:
        for mh in mhs:
            if not os.path.exists(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/instancias'):
                os.makedirs(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/instancias')
            archivoTransitorio = open(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/instancias/{instancia[0]}.csv', 'w')
            ...
            for experimento in experimentos:
                ...
                for ejecucion in ejecuciones:
                    ...
                    ultimo = len(iteraciones) - 1
                    if not math.isnan(fitness[ultimo]):
    ...
    for instancia in instancias:
        for mh in mhs:
            if not os.path.exists(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/Test_instancias'):
                os.makedirs(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/Test_instancias')
            test_estadistico = open(f'{dirResultado}Test_Estadistico/KP/{mh[0]}/Test_instancias/test_estadistico_{mh[0]}_{instancia[0]}.csv', 'w')
            ...
            datos = pd.read_csv(f'{dirResultado}Test_Estadistico/KP/{mh[0]}/instancias/{instancia[0]}.csv')
            for tecnica in experimentos:
                ...
                for t in experimentos:
                    if t[0] != tecnica[0]:
                        ...
                        if not os.path.exists(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/Transitorio'):
                            os.makedirs(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/Transitorio')
                        archivo = open(f'{dirResultado}Test_Estadistico/KP/{mh[0]}/Transitorio/{tecnica[0]}_contra_{t[0]}.csv', 'a')
    ...
    for mh in mhs:
        if not os.path.exists(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/Test'):
            os.makedirs(f'{dirResultado}/Test_Estadistico/KP/{mh[0]}/Test')
        test = open(f'{dirResultado}Test_Estadistico/KP/{mh[0]}/Test/test_estadistico_{mh[0]}.csv', 'w')
        test.write(f' , ')
        experimentos = bd.obtenerExperimentos('KP', mh[0])
        i = 1
        for tecnica in experimentos:
        ...
        for tecnica in experimentos:
            ...
            for t in experimentos:
                if t[0] != tecnica[0]:
                    archivo = pd.read_csv(f'./Resultados/Test_Estadistico/KP/{mh[0]}/Transitorio/{tecnica[0]}_contra_{t[0]}.csv')
                    test.write(f' , {np.round(np.average(archivo.iloc[:, 0 ]),3)} ')
                    os.remove(f'./Resultados/Test_Estadistico/KP/{mh[0]}/Transitorio/{tecnica[0]}_contra_{t[0]}.csv')
                else:
                    test.write(f' , X ')
            test.write(f' \n ')
        test.close()
